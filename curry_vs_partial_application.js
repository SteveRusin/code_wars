...
function curryPartial(fn, ...args) {
  return args.length >= fn.length ? fn(...args) : curryPartial.bind(null, fn, ...args);
}
...
describe("curryPartial tests", function () {
  it("Function with three random parameters", function () {
    ...
    Test.assertEquals(
      curryPartial(curryPartial(curryPartial(add, a), b), c),
      sum,
    );
  ...
  it("Function with four random parameters", function () {
    ...
    Test.assertEquals(curryPartial(curryPartial(add, a)(b, c), d), sum);
    Test.assertEquals(
      curryPartial(curryPartial(curryPartial(add, a), b), c, d),
      sum,
    );
    Test.assertEquals(
      curryPartial(curryPartial(curryPartial(add, a), b), c)(d),
    ...
    Test.assertEquals(
      curryPartial(curryPartial(curryPartial(curryPartial(add, a), b), c), d),
      sum,
    );
  });
